...
The data used in this project is the entire book of \textbf{Alice in Wonderland} written by Lewis Carroll. We get this book from the Gutenberg project. It contains about \textbf{TODO} words and has been splitted into \textbf{TODO} training/validation/text set.
...
At first we wanted to start from a the most simple basis to be able to compare improvements with other architectures. That's why we implement a simple RNN with ADAM optimizer.
